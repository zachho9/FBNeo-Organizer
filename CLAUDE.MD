...
- I am on Windows 11 using Git Bash (MINGW64). Run shell commands via Git Bash using `"C:/Program Files/Git/bin/bash.exe" -c "<command>"`, fallback to PowerShell and cmd.